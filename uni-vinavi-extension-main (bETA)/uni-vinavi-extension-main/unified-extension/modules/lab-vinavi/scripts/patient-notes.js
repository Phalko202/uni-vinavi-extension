            ...
            <div class="pn-modal">
                ...
                <div class="pn-modal-body">
                    ...
                    <div class="pn-form-group">
                        ...
                        <input type="text" id="newPatientIdCard" placeholder="Enter ID card number" value="${isIdCard ? prefillQuery : ''}">
                    </div>
                    <div class="pn-form-row">
                        <div class="pn-form-group">
                            <label>Age</label>
                    ...
                    <div class="pn-tab-content active" id="vinaViTab">
                        <div class="pn-form-group">
                            ...
                            <div class="pn-vinavi-search">
                                <input type="text" id="vinaViSearchId" placeholder="Enter ID card number" value="${prefillId}">
